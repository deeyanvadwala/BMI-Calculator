...
const numtextStyle = TextStyle(color: Colors.white, fontSize: 35, fontWeight: FontWeight.w700);
const textStyle = TextStyle(color: Colors.white, fontSize: 35, fontWeight: FontWeight.bold);
